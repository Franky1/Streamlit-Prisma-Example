...
SCHEMA_PATH = Path('E:/Daten/Python/Streamlit-Prisma-Example/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Administrator\\.cache\\prisma-python\\binaries\\5.4.2\\ac9d7041ed77bcc8a8dbd2ab6616b39013829574\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:posts.sqlite', 'fromEnvVar': None}).resolve(),
        }
